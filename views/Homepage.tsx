            ...
            <div class="row text-center mt-5">
              <div class="col-xl-6" style="padding: 40px">
                ...
                <p class="mt-4">
                  ...
                  language and the area where I excel the most. My journey in
                  web development started with adding JavaScript to basic HTML
                  pages, sparking my interest in this field.
                </p>
              </div>
              <div class="col-xl-6" style="padding: 40px">
                <SkillsGrid />
