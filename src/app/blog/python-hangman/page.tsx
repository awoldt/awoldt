      ...
      <div className="container">
        ...
        <article>
          ...
          <p>
            ...
            will teach you fundamentals such as variables, loops, and user
            input, among other things. This tutorial assumes you understand the
            basics of Python.
          </p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                (int) - Keeps track of a user&apos;s guesses. For this program,
                we will have 5 be the max number of attempts. Anything over will
            ...
            <li>
              <p>
                ...
                (dict) - This is a dictionary that stores the current character
                a user has guessed at each index of the word to guess. The keys
                represent the index of a string and each value represents the
                char at said index. Look at the example below to better
                demonstrate the purpose of this variable:
              </p>
              <ul>
                <li>
                  <p>
            ...
            <li>
              <p>
                ...
                (int) - This variable is to be used when the program first
                starts. It is used to keep track of each index of the word to be
                spelled.
              </p>
            </li>
          </ul>
          ...
          <p>
            ...
            user that the character at a specific index still needs to be
            guessed. For example, if the word is &quot;hello&quot; and the user
            has guessed &quot;learn&quot;, the spelling would be represented as
            _e___. This is because the character <i>e</i> is the only character
            that aligns at the same index with the word &quot;hello&quot;.
          </p>
          <p>
          ...
          <p>
            ...
            the word. This will run forever until the code inside the loop
            breaks it. For this game, the loop will break when the user has not
            guessed the word within five attempts or correctly before the 5th
            attempt.
          </p>
          <p>
          ...
          <p>
            ...
            need to be guessed. For example, with the word being
            &quot;hello&quot; and the user has guessed the word
            &quot;hwlto&quot;, the <var>current_spelling</var>
          ...
          <p>
            The <var>guess</var> variable will be set to whatever the user
            inputs into the terminal. The <i>.lower()</i> function makes sure
            that all inputs from the user are lowercase (prevents errors such as
          ...
          <p>
            ...
            &quot;_&quot; means the user has not guessed the correct character
            or has not guessed the character at the specific index yet (remember
            the program will populate all values in the <var>spelling</var>{" "}
          ...
          <p>
            ...
            <var>spelling</var> dictionary value at the key <var>index</var>{" "}
          ...
          <p>
            ...
            example, add a prompt at the end of the while loop that asks if a
            user would like to play again instead of having the program
