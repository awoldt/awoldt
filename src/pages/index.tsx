    ...
    <>
      ...
      >
        ...
        >
              ...
              <div className="row text-center">
                <div className="col-xl-6" style={{ marginBottom: "50px" }}>
                  ...
                  <div>
                    ...
                    >
                      Blogs{" "}
                      <img src="/icons/file-richtext.svg" alt="blog icon" />
                    </div>
                  </div>
                </div>
                <div className="col-xl-6">
                  ...
                  >
                    ...
                    Charlotte NC. I enjoy coding in my freetime and love
                    learning new technologies and frameworks. JavaScript is my
                    favorite language and is where I excel. I got started
                    implementing JS to basic HTML pages and developed an
                    interest in web development soon after.
                  </p>
                </div>
              </div>
          ...
          {showBlogs && <Blogs showBlogs={setShowBlogs} />}
        </div>
      </div>
    </>
  );
